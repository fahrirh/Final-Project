...
<h1 class="retro bounceInUp animated">Selamat Datang Di Final Project</h1>
<h1 class="retro2 bounceInUp animated">oleh Fahri Ramadhan H</h1>
<h1 class="retro3 bounceInDown animated">klik menu navigasi di atas</h1>
</div>
